...
ActiveRecord::Schema.define(version: 20_160_810_101_124) do
  ...
  create_table 'mailboxer_conversation_opt_outs', force: :cascade do |t|
    ...
    t.index %w(unsubscriber_id unsubscriber_type),
            name: 'index_mailboxer_conversation_opt_outs_on_unsubscriber_id_type', using: :btree
  end
  ...
  create_table 'mailboxer_notifications', force: :cascade do |t|
    ...
    t.index %w(notified_object_id notified_object_type),
            name: 'index_mailboxer_notifications_on_notified_object_id_and_type', using: :btree
  ...
  create_table 'mailboxer_receipts', force: :cascade do |t|
    ...
    t.index %w(receiver_id receiver_type),
            name: 'index_mailboxer_receipts_on_receiver_id_and_receiver_type', using: :btree
  end
